...
_title             = "Welcome to";
_shorttext         = "Invade and Annex customized by GamersCentral.de - MaDmaX[GC]";
_posText        = [0.6,0.5,0.4];


_title2         = "Website";
_shorttext2     = "www.GamersCentral.de";
_posText2        = [0.6,0.5,0.25];


_title3            = "Steam Group";
_shorttext3     = "GamersCentral";
_posText3        = [0.6,0.5,0.25];


_title4         = "Donate";
_shorttext4     = "Support the server and Help it stay up";
_posText4        = [0.6,0.5,0.28];


_title5         = "Teamspeak 3";
_shorttext5     = "TS3.GamersCentral.de";
_posText5        = [0.6,0.5,0.335];


_title6         = "Play Fair And Enjoy";
_shorttext6     = "Admins are Always Active";
_posText6        = [0.6,0.5,0.4];

_title7         = "Join our Community";
_shorttext7     = "Steam Group or Website";
_posText7        = [0.6,0.5,0.4];

_title8        = "Contact us";
_shorttext8     = "Support@GamersCentral.de";
_posText8        = [0.6,0.5,0.4];
