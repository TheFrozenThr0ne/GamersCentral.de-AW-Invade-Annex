...
_rules = parseText "New to this Mission? Read the Description and Information - Press M and click Top left at Mission for info.<br/><br/>This is an Co-Op Server!<br/>Team Killing = BAN<br/>Rape AO w/Aircraft = BAN<br/>Please Play Nice!<br/><br/>Join our Community today at http://Join.GamersCentral.de to get access to Community Commands and Vehicles.<br/><br/>Join our TeamSpeak3 TS3.GAMERSCENTRAL.DE<br/><br/>Please donate to keep this Server alive, type !donate in chat for more information!<br/><br/><br/>Enjoy our Customized Mission. Have Fun!<br/>";
