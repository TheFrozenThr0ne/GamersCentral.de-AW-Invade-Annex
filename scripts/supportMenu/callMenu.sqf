private ["_caller","_attackHelis","_transportHelis","_attackH1","_attackH2","_attackH3","_attackH4","_tranH1","_tranH1_pilot","_tranH2","_tranH2_pilot","_tranH3","_tranH3_pilot","_tranH4","_tranH4_pilot","_tranH5","_tranH5_pilot","_tranH6","_tranH6_pilot","_attackH1_pilot","_attackH2_pilot","_attackH3_pilot","_attackH4_pilot"];
...
if (((_this select 3) select 0) == "transportHelis") then {
    ...
    if ((count _transportHelis) == 4) then {
        ...
        if (!isNull _tranH4_pilot) then {
            ...
            SUPMEN_tHeli4Map = _caller addAction[format ["<t color='#F07422'>Request Transport from <t color='#ECF70C'>%1's</t> <t color='#DE1D1D'>%2</t> at Map Click</t>", name _tranH4_pilot, typeOf _tranH4], "scripts\supportMenu\createTaskMap.sqf", [_tranH4_pilot, "Transport"], -100, false, false, "", "leader group _this == _this && _target == vehicle _this || leader group _this == _this && _target == _this"];
        };
    };
