CHHQ_fnc_deploy = {
	...
	*/
	...
	_deployed = format[
	"<t align='center'><t size='2.2' color='#6DCD64'>MHQ Deployed</t><br/>____________________<br/>You are now able to Spawn at the HQ at GRID %1. From the Base Flag Pole.</t>",mapGridPosition (getPos _veh)];
	GlobalHint = _deployed; publicVariable "GlobalHint"; hint parseText _deployed;
...
CHHQ_fnc_undeploy = {
	...
	_undeployed = format[
	"<t align='center'><t size='2.2' color='#6DCD64'>MHQ Undeployed</t><br/>____________________<br/>You are NOT more able to Spawn at the HQ at GRID %1. MHQ has been Undelpoyed.",mapGridPosition (getPos _veh)];
	GlobalHint = undeployed; publicVariable "GlobalHint"; hint parseText _undeployed;
