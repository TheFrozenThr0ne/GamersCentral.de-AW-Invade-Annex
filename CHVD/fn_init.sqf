[] spawn {
	...
	CHVD_maxView = 1600; // Set maximum view distance (default: 12000)
	CHVD_maxObj = 1600; // Set maximimum object view distance (default: 12000)
	...
	player addAction ["<t color='#FF0000'>Settings</t>", CHVD_fnc_openDialog, [], -99, false, true];
