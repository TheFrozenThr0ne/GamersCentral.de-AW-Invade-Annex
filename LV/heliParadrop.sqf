...
_OPFchopper = "O_Heli_Transport_04_covered_F";
...
{_x addCuratorEditableObjects [(units _heli),FALSE];} count allCurators;
...
if(_patrol)then{
	...
	[_grp2, getPos radioTower] call BIS_fnc_taskDefend;
	} else {
	[_grp2, getPos _obj1] call BIS_fnc_taskDefend;
	};
};
		
{_x addCuratorEditableObjects [(units _grp2),FALSE];} count allCurators;	
