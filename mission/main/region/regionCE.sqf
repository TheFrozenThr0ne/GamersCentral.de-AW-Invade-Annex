...
private ["_target1","_target2","_target3","_targetArray","_pos","_i","_position","_flatPos","_roughPos","_targetStartText","_targets","_targetsLeft","_dt","_enemiesArray","_unitsArray","_radioTowerDownText","_targetCompleteText","_regionCompleteText","_null","_mines","_chance","_tower4","_tower5","_tower6","_credits"];
...
while { count _targetArray > 0 } do {
	...
	_creditsSmall = _creditsSmall + 80000;
	_creditsMedium = _creditsMedium + 80000;
	_creditsBig = _creditsBig + 80000;
