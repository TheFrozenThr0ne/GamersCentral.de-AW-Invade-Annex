...
if(random 1 >= 0.35) then {
	...
	_playersOnlineHint = format [
		"<t size='1.5' align='center' color='#C92626'>Enemy attacking %1!</t><br/><br/>____________________<br/>Get ready boys they are almost here!", currentAO
	];

	_defendTimer1 = 300;			// 480
	_defendTimer2 = random 60;		// 120
	...
	if (_selectedType == 1) then {
		...
		_enemiesArrayDefend = [currentAO] call QS_fnc_AOenemyD;
	};
	...
	hqSideChat = "Assault will end in approximately 6 minutes."; publicVariable "hqSideChat"; [WEST,"HQ"] sideChat hqSideChat;
	...
	[_enemiesArrayDefend] spawn QS_fnc_AOdelete;
};