...
for "_x" from 0 to (2 + (random 4)) do {
	...
	_infteamPatrol setVariable ["NOPATHING",1,false];			
...
for "_x" from 0 to 1 do {
	...
	_indSniperTeam setVariable ["NOPATHING",1,false];
...
_SMvehPatrol setVariable ["NOPATHING",1,false];	
...
for "_x" from 0 to 1 do {
	...
	_SMaaPatrol setVariable ["NOPATHING",1,false];
