...
Script_Taru_Transmission_Son_Message =
{
	...
	[] call
	{
		...
		{
			_helicoptere say "XENO_Helitreuillage_Fixation";
			if (player in crew _helicoptere) then {playSound ["XENO_Helitreuillage_Fixation",true];};
		};

		if (_type_Son_Message isEqualTo "Son Défixation") exitwith
		{
			_helicoptere say "XENO_Helitreuillage_Defixation";
			if (player in crew _helicoptere) then {playSound ["XENO_Helitreuillage_Defixation",true];};
		};

		if (_type_Son_Message isEqualTo "Son Largage") exitwith
		{
			_helicoptere say "XENO_Helitreuillage_Largage";
			if (player in crew _helicoptere) then {playSound ["XENO_Helitreuillage_Largage",true];};
		};
