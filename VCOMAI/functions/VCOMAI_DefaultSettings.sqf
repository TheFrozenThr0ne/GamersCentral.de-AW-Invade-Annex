...
//VCOM_SideBasedExecution- Remove sides from the array below to remove that specific AI side from executing any of the VCOMAI scripts at all.
VCOM_SideBasedExecution = [WEST,EAST,CIVILIAN,RESISTANCE];
//Distance AI will respond to each other
VCOM_Unit_AIWarnDistance = 400;
